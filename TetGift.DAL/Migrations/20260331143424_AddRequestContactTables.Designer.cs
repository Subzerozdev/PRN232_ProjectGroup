...
namespace TetGift.DAL.Migrations
{
    ...
    [Migration("20260331143424_AddRequestContactTables")]
    partial class AddRequestContactTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TetGift.DAL.Entities.Quotation", b =>
                {
                    ...
                    b.Property<int?>("Adminreviewerid")
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal?>("Desiredbudget")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("desiredbudget");

                    b.Property<string>("Desiredpricenote")
                        .HasColumnType("text")
                    ...
                    b.Property<int?>("Staffreviewerid")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TetGift.DAL.Entities.QuotationCategoryRequest", b =>
                {
                    b.Property<int>("Quotationcategoryrequestid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("quotationcategoryrequestid");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Quotationcategoryrequestid"));
                    ...
                    b.HasKey("Quotationcategoryrequestid")
                        .HasName("quotation_category_request_pkey");

                    b.HasIndex("Categoryid");

                    b.HasIndex("Quotationid");

                    b.ToTable("quotation_category_request", (string)null);
                });
            ...
            modelBuilder.Entity("TetGift.DAL.Entities.QuotationMessage", b =>
                {
                    b.Property<int>("Quotationmessageid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("quotationmessageid");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Quotationmessageid"));
                    ...
                    b.HasKey("Quotationmessageid")
                        .HasName("quotation_message_pkey");
            ...
            modelBuilder.Entity("TetGift.DAL.Entities.QuotationCategoryRequest", b =>
                {
                    ...
                    b.HasOne("TetGift.DAL.Entities.Quotation", "Quotation")
                        .WithMany("QuotationCategoryRequests")
            ...
            modelBuilder.Entity("TetGift.DAL.Entities.QuotationFee", b =>
                {
                    b.HasOne("TetGift.DAL.Entities.Quotation", null)
            ...
            modelBuilder.Entity("TetGift.DAL.Entities.Quotation", b =>
                {
                    b.Navigation("QuotationCategoryRequests");

                    b.Navigation("QuotationFees");

                    b.Navigation("QuotationItems");

                    b.Navigation("QuotationMessages");
                });
